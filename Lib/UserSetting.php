...
class UserSetting implements Output {
	...
	public function commit(){
		...
		$this->_getDAO();
		$event->triggerEvent(new UserSettingModifyBeforeCommit($this));
		$r = $this->_update();
		$event->triggerEvent(new UserSettingModifyAfterCommit($this));
		return $r;
	}
	...
	public function getXML(DOMDocument $xml){
		$usersetting = $xml->createElement('usersetting'); 
		/* Get XML method */
