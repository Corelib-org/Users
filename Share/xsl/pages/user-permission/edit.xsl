		...
		<form method="post">
			<div>
				...
				<xsl:call-template name="user-permission-edit-ident">
					<xsl:with-param name="ident" select="/page/settings/get/ident|user-permission/@ident" />
				</xsl:call-template>
				<xsl:call-template name="user-permission-edit-title">
					<xsl:with-param name="title" select="/page/settings/get/title|user-permission/@title" />
				</xsl:call-template>
				<xsl:call-template name="user-permission-edit-description">
					<xsl:with-param name="description" select="/page/settings/get/description|user-permission/@description" />
				</xsl:call-template>
				<!-- Edit end -->
			</div>
