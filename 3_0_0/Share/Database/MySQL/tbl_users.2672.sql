CREATE TABLE `tbl_users` (
  ...
  `deleted` enum('TRUE','FALSE') COLLATE utf8_bin NOT NULL DEFAULT 'FALSE',
  ...
  KEY `deleted` (`deleted`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Revision: 2672' AUTO_INCREMENT=3 ;
