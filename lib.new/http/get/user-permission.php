...
class WebPage extends ManagerPage {
	...
	public function UserPermissionList(){
		...
		$this->xsl->addTemplate(CORELIB.'/Users/share/xsl/pages/user-permission/list.xsl');
	}

	public function edit($id){
		$user_permission = new UserPermission($id);
		if($user_permission->read()){
			$this->xsl->addTemplate(CORELIB.'/Users/share/xsl/pages/user-permission/edit.xsl');
			$this->addContent($user_permission);
		} else {
	...
	public function delete($id){
		...
		if($user_permission->read()){
			...
			$this->xsl->setLocation('corelib/extensions/Users/Permissions/');
		} else {
			$this->xsl->addTemplate('share/xsl/pages/404.xsl');
		}
	}
